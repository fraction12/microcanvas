...
- [ ] 2.2 Add a regression check that exported snapshots are not blank.
- [x] 2.3 Keep the viewer and CLI test suites green.

## 3. Validation
- [x] 3.1 Run the relevant build/test commands.
